...
CARRUSEL
=================================================-->
  <div class="owl-carousel owl-theme inicio__carrousel">
      <div class="carrousel__item01"></div>
      <div class="carrousel__item02"></div>
      <div class="carrousel__item03"></div>
  </div>
  <div class="inicio__titulo general__titulo"><h1>Soluciones en tecnología para tu proyecto</h1></div>

  <p>Nos preocupamos por dar siempre el mejor servicio a nuestros clientes logrando cumplir todas las expectativas</p>
  ...
  <div class="general__titulo"><h1>Servicios destacados</h1></div>
...
<script src="view/src/js/carousel.js"></script>
